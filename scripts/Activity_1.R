################################################################
## Activity 1,  Help commands
################################################################

# After entering any computer program, it's always a good idea to
# know how to exit.  To quit R at any time, simply type the following
# at the prompt:
...
# the help file for the seq() function:
?seq
