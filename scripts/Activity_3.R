...
# Save the 'nf-week2-sample.csv' file to your computer. If you
# are using a server version of R studio (running in a web
# browser), you'll need to upload this file from your computer
# to the the server using the `Upload` button in top of the lower
# right quadrant of R studio.
...
#    it if necessary to the R studio server). Verify that the file
#    "some_fake_data.csv" is in your working directory using dir()
#
...
# The "repos" argument allows you to specify a CRAN mirror.  For this
# example, we'll use the CRAN mirror at the Fred Hutchinson Cancer
# Research Center. If you omit the "repos" argument, R will prompt
# you with a pop-up window to select a CRAN mirror. Typically, you want
